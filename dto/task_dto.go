...
// 	AssigneeID  string   `json:"assignee_id" binding:"required"` // hex ObjectID
...
// // TaskSummary is used in the list view (task cards / rectangular blocks).
// // Description is intentionally omitted — only shown on the detail page.
...
// // TaskDetail is used on the view / edit page — includes full Description.
...
// 	Search   string `form:"search"` // matches title prefix (case-insensitive)
