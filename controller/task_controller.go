...
// // The AuthMiddleware is expected to set "user_id" as a primitive.ObjectID.
...
// // parseTaskID parses the ":id" route parameter as a MongoDB ObjectID.
// func parseTaskID(c *gin.Context) (primitive.ObjectID, error) {
// 	return primitive.ObjectIDFromHex(c.Param("id"))
// }

// // handleTaskError maps service-layer sentinel errors to HTTP status codes.
...
// // CreateTask creates a new task. The authenticated user becomes AssignedBy.
// //
// // Request body: dto.CreateTaskRequest
...
// // A task is visible if the user is either Assignee or AssignedBy.
// //
// // Query params:
// //
// //	page      int    (default 1)
...
// // Only the Assignee or AssignedBy may view.
// //
...
// // Only the AssignedBy (creator) may edit. All fields are optional.
// //
...
// // DeleteTask soft-deletes a task by setting is_deleted = true.
// // Only the AssignedBy (creator) may delete.
// //
